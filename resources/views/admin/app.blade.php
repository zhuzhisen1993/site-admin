                                ...
                                <div class="pull-right">
                                    <a href="{{ url('admin/logout')}}" class="btn btn-default btn-flat"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-admin-form').submit();">退出</a>
                                    <form id="logout-admin-form" action="{{ url('admin/logout') }}" method="POST" style="display: none;">
                                        {{ csrf_field() }}
                                    </form>
                                </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview @if($nav_active == 'Product') active @endif">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="{{url('admin/productOption')}}"><i class="fa fa-circle-o"></i>产品属性管理</a></li>
                        <li><a href="{{url('admin/option')}}"><i class="fa fa-circle-o"></i>属性管理</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="#"><i class="fa fa-circle-o"></i>角色表格</a></li>
                    </ul>
                </li>
